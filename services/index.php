...
<head>
    ...
    <title>Our Service - Busniz</title>
            ...
            <div class="row align-items-center">
                        ...
                        <nav>
                            <ul class="menu">
                                ...
                                <li class="dropdown dropdown-1 item-has-children">
                                    Pages
                                    <ul class="dropdown_menu dropdown_menu-1">
                                        <li class="dropdown_item-1"><a href="#">Case Study</a>
                                ...
                                <li class="dropdown dropdown-1 item-has-children">
                                    News
                                    <ul class="dropdown_menu dropdown_menu-1">
                                        <li class="dropdown_item-1"><a href="#">Our Style</a>
                                            <ul class="dropdown_menu dropdown_menu-1 dropdown_menu-2">
                                        ...
                                        <li class="dropdown_item-1"><a href="#">Blog</a>
                                            <ul class="dropdown_menu dropdown_menu-1 dropdown_menu-2">
                ...
                <div class="col-lg-3">
                    ...
                    <ul class="top-bar-icon">
                        ...
                        <li class="bar-menu"><a href="#"><i class="fa fa-solid fa-bars"></i></a></li>

                        <li><a href="#"><i class="fa fa-search search-btn"></i></a></li>
    ...
    <div class="mobile-nav" id="mobile-nav" style="display: block;">
        ...
        <div class="res-log">
            ...
            <a href="index.html">
                ...
                <img style="height: auto;" src="img/logo-b.png" alt="Responsive Logo">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="studies">
                    ...
                    <a href="#" class="on"><i class="fa fa-angle-right"></i>Our Service</a>
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="500" data-aos-duration="1000">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
                ...
                <div class="Service drop-box">
                    ...
                    <a href="#">Creative Business
                        Strategy</a>

                    <h6>Lorem ipsum is simply free text a
                        dolor sit amet, consectetur no tted
                        adipisicing elit sed.</h6>
